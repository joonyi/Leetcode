...
put functions for that item since it was inserted. This number is set to zero when the item is removed.
"""
...
capacity = 2
obj = LFUCache2(capacity)
obj.put(1, 1)
obj.put(2, 2)
print(obj.get(1))  # 1
obj.put(3,3)  # evicts key 2 bcs 2 least used
print(obj.get(2))  # -1 (not found)
print(obj.get(3))  # 3
obj.put(4, 4)  # evicts key 1  because least recently used
print(obj.get(1))  # -1 (not found)
print(obj.get(3))  # 3
print(obj.get(4))  # 4
